...
public record SettingsDto(
    ...
    int FreezerWarnAboveCelsius,
    int HumidityWarnAbovePercent,
    int? ActiveProfileId)
{
    public static SettingsDto From(HouseholdSettings s) => new(
        s.IdleTimeoutMinutes, s.IdleDimmingEnabled,
        s.FreezerWarnAboveCelsius, s.HumidityWarnAbovePercent, s.ActiveProfileId);
}
