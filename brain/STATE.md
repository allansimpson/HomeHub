...
| Gap | TEST artifact is explicitly TEST-only and production-ineligible. Fresh independent review of exact `f961a0a` failed closed with 0 Critical / 3 High: Chatterbox cleartext bypass, incomplete RR-05 dropped-key sanitation, and caller-triggered global retention deletion of other profiles' conversations without durable Hermes transcript tombstones. Production remains blocked. |
